...
CREATE TABLE `230512signup_table` (
  ...
  `gaib_date` TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '가입일자'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='마켓컬리 회원가입 테이블';


// 더미 데이터 입력 
INSERT INTO 230512signup_table(id, pw, name, email, hp, addr, gender, birth, chooga, service)
VALUES("tmfrl4994", "123456", "정슬기", "tmfrl4994@naver.com", "01077716035", "인천 송도", "여자", "200130", "다주세요","이용약관동의...");
--
-- 덤프된 테이블의 인덱스
--
